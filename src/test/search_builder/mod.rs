...
mod search_builder {
    ...
    fn format() {
        assert_eq!(
            Builder::new().add(Format::new("standard")).stringify(),
            "f:standard"
        );
    }
    ...
    fn magic_type() {
        assert_eq!(
            Builder::new().add(MagicType::new("legendary")).stringify(),
            "t:legendary"
        );
    }
    ...
    #[test]
    fn cmc() {
        assert_eq!(Builder::new().add(Cmc::even()).stringify(), "cmc:even");
    }

    #[test]
    fn is_spell() {
        assert_eq!(Builder::new().add(IsSpell).stringify(), "is:spell");
    }

    #[test]
    fn is_permanent() {
        assert_eq!(Builder::new().add(IsPermanent).stringify(), "is:permanent");
    }

    #[test]
    fn is_buyabox() {
        assert_eq!(Builder::new().add(IsBuyABox).stringify(), "is:buyabox");
    }
}
